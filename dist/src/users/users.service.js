...
let UsersService = class UsersService {
    repo;
    appConfiguration;
    constructor(repo, appConfiguration) {
        this.repo = repo;
    ...
    async updatePassword(id, dto) {
        ...
        const hashedPassword = await bcrypt.hash(dto.newPassword, this.appConfiguration.hashSalt);
...
exports.UsersService = UsersService = __decorate([
    ...
    __param(1, (0, common_1.Inject)(app_config_1.appConfig.KEY)),
