...
export function CategoryGetAll(){
    return applyDecorators(
        ...
        ApiResponse({status: 200, description: 'All categories have been successfully received.'} ),
...
export function CategoryGetById()
{
    return applyDecorators(
        ...
        ApiResponse({status: 200, description: 'Category has been successfully received.'} ),
    )
}
